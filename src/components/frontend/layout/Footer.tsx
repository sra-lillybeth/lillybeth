...
import { siteConfig, getWhatsAppLink, getMailtoLink } from '@/config';
          ...
          <div>
            ...
            <ul className="mt-4 space-y-3">
              <li>
                <a
                  href={getMailtoLink()}
                  className="text-sm text-stone-400 hover:text-white transition-colors duration-200 flex items-center gap-2"
                >
      ...
      <div className="border-t border-stone-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <p className="text-center text-sm text-stone-500">
            {replacePlaceholders(t.footer.copyright, { year: currentYear })}
          </p>
        </div>
      </div>
    </footer>
